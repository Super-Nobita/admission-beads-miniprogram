// MARD standard 221-color palette (A-H and M series).
// HEX values are screen references; physical beads can vary by batch and light.
const MARD_221_HEX = {
...
const MARD_221_COLORS = Object.keys(MARD_221_HEX).reduce((colors, series) => {
  MARD_221_HEX[series].forEach((hex, index) => {
